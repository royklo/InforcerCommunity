...
'@
    ...
    [void]$sb.AppendLine('            }')
    [void]$sb.AppendLine('        }')
    [void]$sb.AppendLine('        var hidden = !matchesSearch || !matchesFilter || !matchesCategory || !matchesAssigned;')
    ...
    [void]$sb.AppendLine('        var hasActive = activeFilters.size > 0 || q !== "" || (catFilter && catFilter.value !== "All") || excludeUnassigned;')
